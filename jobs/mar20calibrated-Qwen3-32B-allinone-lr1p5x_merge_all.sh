...
#PJM -N mar20c-Qwen3-32B-lr1p5x_merge
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar20calibrated-Qwen3-32B-allinone-lr1p5x_merge_all.out
cd "$HOME/bea2026st"
...
conda run --no-capture-output -n llm_newer python -u \
  ...
  --run-names mar20calibrated-Qwen3-32B-allinone-lr1p5x--Qwen--Qwen3-32B
