...
#PJM -N mar20c-Qwen25-32B-lr1p5x_f4
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar20calibrated-Qwen2.5-32B-allinone-lr1p5x_fold4.out
cd "$HOME/bea2026st"
...
FOLDS=4 conda run --no-capture-output -n llm_newer \
  ...
  -v \
  --config-name mar20calibrated-Qwen2.5-32B-allinone-lr1p5x \
