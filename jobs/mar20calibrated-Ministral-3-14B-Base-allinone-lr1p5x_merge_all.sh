...
#PJM -N mar20c-Ministral-14B-lr1p5x_merge
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar20calibrated-Ministral-3-14B-Base-allinone-lr1p5x_merge_all.out
cd "$HOME/bea2026st"
...
conda run --no-capture-output -n llm_plus python -u \
  ...
  --run-names mar20calibrated-Ministral-3-14B-Base-allinone-lr1p5x--mistralai--Ministral-3-14B-Base-2512
