...
#PJM -N ftllm_feb24calibrated-Ministral-3-8B-Base-allinone_folds3to4
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_feb24calibrated-Ministral-3-8B-Base-allinone_folds3to4.out
cd "$HOME/bea2026st"

module load miniconda/py39_4.9.2

FOLDS=3-4 conda run --no-capture-output -n llm_plus \
