...
#PJM -N ftllm_feb24calibrated_merge_32b_lr2x
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_feb24calibrated_merge_32b_lr2x.out
cd "$HOME/bea2026st"
...
#   --dry-run \
#   --run-names \
#   feb24calibrated-esde32b-lr2x--zai-org--GLM-4-32B-Base-0414 \
