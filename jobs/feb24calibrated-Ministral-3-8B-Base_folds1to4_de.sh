...
#PJM -N ftllm_feb24calibrated-Ministral-3-8B-Base_folds1to4_de
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_feb24calibrated-Ministral-3-8B-Base_folds1to4_de.out
cd "$HOME/bea2026st"
