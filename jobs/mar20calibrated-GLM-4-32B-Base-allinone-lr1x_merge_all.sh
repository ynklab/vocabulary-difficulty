...
#PJM -N mar20c-GLM32B-lr1x_merge
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar20calibrated-GLM-4-32B-Base-allinone-lr1x_merge_all.out
cd "$HOME/bea2026st"
...
conda run --no-capture-output -n llm_newer python -u \
  ...
  --run-names mar20calibrated-GLM-4-32B-Base-allinone-lr1x--zai-org--GLM-4-32B-Base-0414
