...
#PJM -N ftllm_feb24calibrated_folds2to5_cn_32b_lr1x
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_feb24calibrated_folds2to5_cn_32b_lr1x.out
cd "$HOME/bea2026st"
...
FOLDS=2-5 conda run --no-capture-output -n llm_newer \
  ...
  -v \
  --config-name feb24calibrated-cn32b-lr1x \
