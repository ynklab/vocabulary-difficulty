...
#PJM -N mar20c-Qwen3-14B-lr1x_f4
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar20calibrated-Qwen3-14B-Base-allinone-lr1x_fold4.out
cd "$HOME/bea2026st"
...
FOLDS=4 conda run --no-capture-output -n llm_newer \
  ...
  -v \
  --config-name mar20calibrated-Qwen3-14B-Base-allinone-lr1x \
