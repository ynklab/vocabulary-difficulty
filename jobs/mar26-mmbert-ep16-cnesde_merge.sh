...
#PJM -N mar26-mmbert-ep16-cnesde_merge
#PJM -j
#PJM -o results/finetuned_llm/logs/pj_ftllm_mar26-mmbert-ep16-cnesde_merge.out
...
conda run --no-capture-output -n llm_plus python -u \
  ...
  --run-names mar26-mmbert-ep16-cnesde--jhu-clsp--mmBERT-base
